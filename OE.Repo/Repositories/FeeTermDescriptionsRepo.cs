...
namespace OE.Repo
{
    public class FeeTermDescriptionsRepo<T> : IFeeTermDescriptionsRepo<T> where T : FeeTermDescriptions
    {
        private readonly OurEduMediaContext context;
        private DbSet<T> entities;
        string errorMessage = string.Empty;
        public FeeTermDescriptionsRepo(OurEduMediaContext context)
        {
